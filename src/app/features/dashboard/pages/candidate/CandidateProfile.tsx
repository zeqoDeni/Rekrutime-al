...
export default function CandidateProfile() {
  ...
  const handleChange = (field: keyof CandidateProfileFormData, value: string) => {
  ...
  const handleSave = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setIsSaving(true);
    try {
      const validatedData = candidateProfileSchema.parse(formData);
  ...
  if (!user) {
    return (
      <DashboardLayout title="Profili i Kandidatit">
    ...
    <DashboardLayout title="Profili i Kandidatit">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Rifreskoni emrin tuaj. Email-i nuk mund të ndryshohet direkt.</CardDescription>
        </CardHeader>
        <CardContent>
